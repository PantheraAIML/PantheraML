...
from pantheraml_zoo.patching_utils import (
    patch_compiling_bitsandbytes,
    patch_layernorm,
    patch_torch_compile,
    patch_model_and_tokenizer,
...
from pantheraml_zoo.gradient_checkpointing import (
    Unsloth_Offloaded_Gradient_Checkpointer,
    unsloth_offloaded_gradient_checkpoint,
    patch_unsloth_gradient_checkpointing,
    unpatch_unsloth_gradient_checkpointing,
...
from pantheraml_zoo.compiler import (
...
from pantheraml_zoo.temporary_patches import (
    TEMPORARY_PATCHES,
)
...
if torch.cuda.device_count() >= 1:
    ...
    # Enable multi-GPU support - override Accelerate's single GPU limitation
        ...
        if torch.cuda.device_count() > 1:
            try:
                ...
                if dist.is_initialized():
                    return None, DistributedType.MULTI_GPU
            except:
                pass
    ...
    # Only disable distributed for single GPU setups
    if torch.cuda.device_count() == 1:
